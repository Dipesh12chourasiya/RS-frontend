...
const ViewEquipmentDetails = () => {
  ...
  return (
    <>
    {Data && (<div className=' px-4 md:px-12 py-8 bg-zinc-200 flex flex-col md:flex-row gap-8'>
        <div className='bg-zinc-400 rounded p-4  h-[70vh] lg:h-[88vh]  w-full lg:w-3/6 flex  items-center justify-center' ></div>
        ...
        <p className='mt-4 text-orange-500 text-3xl font-semibold'>Price : ₹ {Data.price}</p>
        </div>
        </div>
        )}
